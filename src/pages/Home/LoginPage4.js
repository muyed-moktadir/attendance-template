            ...
            <div className="card flex-shrink-0 md:h-[80vh] w-full max-w-sm shadow-2xl bg-base-100 rounded-none">
                <div className="card-body justify-center">
                    ...
                    <h1 className='text-center font-bold text-2xl '>SignUp Form</h1>
                        <input onBlur={(e) => setPassword(e.target.value)} type="text" placeholder="password" className="input rounded-none border-b-2 border-slate-300 appearance-none bg-transparent border-t-0 border-l-0 border-r-0 leading-tight focus:outline-none mt-20 mb-7" />
                    </div>
                    ...
                    <div className="form-control mt-[-30px]">
                        
                            <Link  onClick={() => setCondition34(!condition34)} className="link link-secondary no-underline">Back</Link>
